...
- **Two Display Modes**:
  - **Time Remaining**: Shows hours and minutes in readable format (e.g., "9 hrs 30 mins", "1 hr", "45 mins")
...
2. Choose your preferred display mode:
   - **Time Remaining (hrs/mins)**: Shows remaining time in readable format (e.g., "9 hrs 30 mins")
   - **Percentage Remaining**: Shows percentage of day left (e.g., "65.4%")

### Example Displays

At 2:30 PM (14:30):
- **Time Mode**: Shows "9 hrs 30 mins" (9 hours 30 minutes until midnight)
- **Percentage Mode**: Shows "39.6%" (39.6% of the day remaining)

At 10:00 PM (22:00):
- **Time Mode**: Shows "2 hrs" (2 hours until midnight)
- **Percentage Mode**: Shows "8.3%" (8.3% of the day remaining)

At 11:59 PM (23:59):
- **Time Mode**: Shows "1 min" (1 minute until midnight - note singular form)
- **Percentage Mode**: Shows "0.1%" (0.1% of the day remaining)

## How It Works

The app calculates the time remaining until midnight (00:00) each day:

- **Time Remaining Mode**: Displays in readable format with proper singular/plural forms (e.g., "1 hr" vs "2 hrs")
...
- **Time Remaining (hrs/mins)**: Switch to time-based display with readable format
